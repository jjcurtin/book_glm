...
this is a very very very long line that wraps around to a new line so that we can see what it looks like (single return).  We needed some more text to continue to make sure it wrapped to a  new line.  Hopefully this is enough.   I think it is enough.

This is a single return (above)

\

This is a single backslash (above) 

- list 1
- list 2

This is a single return after a list (above)
...
This is a line after a backslash following list (above)
