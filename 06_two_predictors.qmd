...
:::{.fragment}
[A model comparison between the mean only model and the one predictor study hours model. Error is reduced in the `iq` model because `iq` explains variability that was previously unexplained in the mean-only model.]{style="color:blue;"}
