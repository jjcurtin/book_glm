...
<span style="color: blue;">The test of the main effect is not needed (with one exception) to reduce the probability of making any Type I errors. In many instances, it will increase the probability of Type 2 errors. This is a **big** misconception in our field.</span>
