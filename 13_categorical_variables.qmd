...
```{r}
cor(data$alcohol_v_depress, data$patient_v_control) |> 
  round(5)
```
...
**Test-wise error rate:** The probability of making a type I (or II) error for any specific statistical test. [What is it for type I and type II?]{style="color:red;"}
...
$alpha_{set}} \le set size*alpha_{test}$
