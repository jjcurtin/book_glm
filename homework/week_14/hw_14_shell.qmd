...
### 1. Read in the data (`hw_14_interactions.csv`), convert names to snake case, and update class categories according to our class conventions.
...
#### a. Mean center `condition` and transform `race` to dummy coding. 
...
#### c. Give a brief interpretation of each coefficient in these models (intercept included).
