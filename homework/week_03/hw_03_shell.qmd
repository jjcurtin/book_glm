...
---
Due Friday, September 26, 2025, 8:30AM on Canvas.   
...
#### b. Create a new variable `stray_z`, that is the standardized score (i.e., has a mean of 0 and a standard deviation of 1) of `stray_total`.
