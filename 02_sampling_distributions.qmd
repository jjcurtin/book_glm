...
<span style="color: red;">Question: What factors affect the size of the standard error (i.e., its sampling error) of the mean (i.e., the standard error)?</span>
...
<span style="color: blue;">If each sample contained only 1 participant, the the standard error of the mean would be equal to the standard deviation ($\sigma$) observed for the population raw scores.  This is the upper bound of the for how much sampling error you can expect (its biggest when you have the smallest possible sample size)</span>   
