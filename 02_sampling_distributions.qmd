...
- [Slide deck](https://jjcurtin.quarto.pub/02_sampling_distributions/) on QuartoPub
...
<span style="color: blue;">As the sample size increases, the standard error of the mean will decrease.</span>   
...
<span style="color: blue;">If each sample contained only 1 participant, the standard error of the mean would be equal to the standard deviation ($\sigma$) observed for the population raw scores.  This is the upper bound for how much sampling error you can expect (it is biggest when you have the smallest possible sample size)</span>   
