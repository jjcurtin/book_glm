...
<!--KW: fix mu formatting in answer code block-->
...
#| code-fold: true
#| code-summary: "Show Answer"
Inhabitants of the island are neutral on average on the Ocean Liking Scale;
$\mu$ = 0
```
:::
...
#| code-fold: true
#| code-summary: "Show Answer"
Excluding issues of measurement of the scale (i.e., reliability), you are 100%
confident that the population mean score on this scale is 0 ($\mu$ = 0). 
```
:::
...
#| code-fold: true
#| code-summary: "Show Answer"
You will very rarely have access to all scores in the population. Instead, you 
...
#| code-fold: true
#| code-summary: "Show Answer"
A sample mean of 2.14 is not 0. However, you know that the sample mean will not
...
#| code-fold: true
#| code-summary: "Show Answer"
A sample mean of 1.74 is not 0. However, she knows that the sample mean will not
...
#| code-fold: true
#| code-summary: "Show Answer"
The mean of the sample means (i.e., the mean of the sampling distribution) will 
...
#| code-fold: true
#| code-summary: "Show Answer"
No, there was a distribution of means that varied from each other. The mean of the 
...
#| code-fold: true
#| code-summary: "Show Answer"
The SE would equal 0 no matter which participants you sampled. They would all have 
the same scores!
```
:::
...
#| code-fold: true
#| code-summary: "Show Answer"
If the sample contained all participants from the population, the SE would be equal 
...
#| code-fold: true
#| code-summary: "Show Answer"
If each sample contained only 1 participant, the SE would be equal to the variation 
...
If $H_0$ is true; the sampling distribution has a mean of 0 and standard deviation of $\frac{\sigma}{\sqrt{N_sample}} =  \frac{23.7}{\sqrt{10}}  =  7.5$.   
...
#| code-fold: true
#| code-summary: "Show Answer"
Our sample mean from our study. This is our parameter estimate of the population
...
#| code-fold: true
#| code-summary: "Show Answer"
This was our estimate of the standard deviation of the sampling distribution. $\frac{\sigma}{\sqrt{N_sample}}$ 
...
#| code-fold: true
#| code-summary: "Show Answer"
We can use our sample standard deviation ($s$), but $s$ is a negatively biased parameter
...
#| code-fold: true
#| code-summary: "Show Answer"
We account for this underestimation of $\sigma$ and therefore of the standard deviation
...
$t(df)$ = $\frac{Parameter estimate – Parameter: H_0}{Standard error of parameter estimate}$   
\          
