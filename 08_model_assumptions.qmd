...
qqPlot(c1$x, id = FALSE, 
       main = "Quantile-Comparison Plot + Skew (Chi-sq w/DF = 3; N = 100)",
       ylab = "c1") 

t1 <- tibble(x = rt(100, 3))
qqPlot(t1$x, id = FALSE, main = "Quantile-Comparison Plot for Heavy Tailed (t w/DF = 3; N = 100)",
       ylab = "t1") 
```
