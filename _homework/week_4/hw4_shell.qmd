...
Due <!--Wednesday, October 4th, 2023, at 1:30 PM. --> on Canvas.   

-	Select the Assignments menu and find HW Week 4
...
### 3.	Prepare your two predictor variables and your outcome variable for data analysis. To do so, create composite scores for participant’s belief in conspiracy theory scores and anxiety scores. Do not include any participant in a composite score if they have missed more than 1/3 of the response items for a variable. While it will not affect your interpretation of b1, later in the homework we will ask you to interpret b0. For the sake of easier interpretation of b0, recode social media use age -0.5 (does not use social media) and 0.5 (uses social media).
...
### 5.	Fit a linear model to determine if anxiety predicts the belief in conspiracy theories. Report the corresponding (b1) parameter estimate, F-statistic, df, p-value, and PRE. Provide a 95% confidence interval for the (b1) parameter estimate. 
...
## Part C. Tell us how long it took you to complete this assignment. 
