...
Practice skimming a subset of the dataframe (from condition to post_proc)
...
Create a new variable (`post_diff`) that is the difference between the mean posttest score (`posttest_m`) and pretest score on knowledge of the physics concept (`pretest`)
...
## 7. Make a scatter plot with raw pretest score on the x-axis, mean posttest score on the y-axis.
