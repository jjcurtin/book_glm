...
[We could use this model to test the relationship between BAC and FPS scores AND the typical FPS scores for participants with a specific value for BAC (default is BAC = 0)]{style="color:blue;"}
:::
