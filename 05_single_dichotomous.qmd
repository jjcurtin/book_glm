...
- How to code a dichotomous predictor into a regressor ($X$ in a glm) using dummy coding and centered coefficients
...
- How to make publication quality figures of these models with dicotomous predictors