...
# Note that negative values exist.  Could make plot manually to fix this
# But this is just a quick demonstration
...
- Model predicts probability of Y = 1 ($\pi$).  Link function is logit (or log-odd; A transformation of these predicted probabilities).   
