...
Interactions with respect to log-odds($Y$) are handled exactly as in the linear model
...
- The interaction can be significant in log-odds($Y$) but not for probability ($Y$) and vice versa!
