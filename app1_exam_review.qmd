...
- What are some solutions to deal with multicolinearity?
...
- What are the appropriate compact and augmented models for testing model $R^2$?
...
- What are the three variance based effect size estimates for models with two or more predictors?
  ...
  - What is the interpretation of each?
