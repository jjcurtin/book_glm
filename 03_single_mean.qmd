...
<span style="color: blue;">... But we  collect a sample from the population and use the sample mean ($\overline{X}$) as an estimate of the population mean ($\mu$). $\overline{X}$ is an unbiased estimate for $\mu$.</span>
