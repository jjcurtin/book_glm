...
### <span style="color: red;">Question: Describe the logic of how this was determined given your understanding of sampling distributions?</span>
...
$t(df=N-P)=\frac{b_0-0}{SE_{b_0}}=\frac{32.2-0}{3.8}=8.40$   
\

$b_0$ is approximately `r round(broom::tidy(m)$estimate/broom::tidy(m)$std.error)` standard deviations above the expected mean of the distribution if $H_0$ is true.  
...
**$\text{CI}(b_0)= b_0 \pm t(\alpha;N-P) * SE_{b_0}$**   
\
